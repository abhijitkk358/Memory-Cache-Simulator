...
// jo info chahiye vo calculate krke rkh li
...
void simulate(vector<ull> trace, Policy policy, ofstream& out) {
    ...
    for (int i = 0; i < trace.size(); i++) {
        ...
        int setIndex = (addr >> offset_bits) & ((1 << index_bits) - 1);
...
int main() {
    ...
    cout << "statistics.out ko checout kre" << endl;
